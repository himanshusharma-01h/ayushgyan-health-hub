...
const DisclaimerSection = () => {
  return (
    <section id="disclaimer" className="py-10 sm:py-16">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <div className="bg-card border border-border rounded-2xl p-5 sm:p-8">
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-9 sm:w-10 h-9 sm:h-10 rounded-xl bg-ayush-gold/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                <AlertTriangle className="w-4 sm:w-5 h-4 sm:h-5 text-ayush-gold" />
              </div>
              <div>
